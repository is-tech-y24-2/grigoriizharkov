...
public class Cat {
    ...
    public boolean equals(Object o) {
        ...
        Cat that = (Cat) o;
        return id == that.id && Objects.equals(name, that.name) && Objects.equals(birthdate, that.birthdate) && Objects.equals(species, that.species) && Objects.equals(color, that.color);
    }
